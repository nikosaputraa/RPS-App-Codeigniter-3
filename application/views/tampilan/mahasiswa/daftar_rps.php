                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="<?php echo site_url('mahasiswa/detail_file/' . $data->id) ?>"
                                class="btn btn-dark" style="font-size: 12px;"><i class="fa-solid fa-eye"></i></a>
                            <a href="<?php echo site_url('mahasiswa/view_file/' . $data->id) ?>" class="btn btn-primary"
