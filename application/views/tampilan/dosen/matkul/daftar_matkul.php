                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="<?php echo site_url('dosen/detail_matkul/'. $data->id_matkul) ?>"
                                class="btn btn-primary" style="font-size: 10px;"><i class="fa-solid fa-circle-info"></i>
                                Details</a>
                            <a href="<?php echo site_url('dosen/edit_matkul/'. $data->id_matkul) ?>"
                                class="btn btn-warning" style="font-size: 10px;">
                                <i class="fa-solid fa-pen-to-square"></i> Edit</a>
                            <a href="<?php echo site_url('dosen/upload_materi/' . $data->id_matkul . '/' . $data->kode_matkul) ?>"
                                class="btn btn-info mt-1" style="font-size: 10px;">
                                <i class="fa-solid fa-upload"></i> Upload Materi</a>

                            <a href="<?php echo site_url('dosen/delete_matkul/'. $data->id_matkul. '/' . $data->kode_matkul) ?>"
                                class="btn btn-danger mt-1" style="font-size: 10px;"><i class="fa-solid fa-trash"
                                    name="delete_matkul"></i> Delete
                            </a>
                        </td>
                    </tr>
                    <?php $i++; ?>
